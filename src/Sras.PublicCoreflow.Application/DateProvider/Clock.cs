...
namespace Sras.PublicCoreflow.DateProvider
{
    public class Clock : IClock, ITransientDependency
    {
        ...
        public virtual DateTime Now => Options.Kind == DateTimeKind.Utc ? DateTime.UtcNow + SimulationDateTimeOffset.OffSetFromNow : DateTime.Now + SimulationDateTimeOffset.OffSetFromNow;
