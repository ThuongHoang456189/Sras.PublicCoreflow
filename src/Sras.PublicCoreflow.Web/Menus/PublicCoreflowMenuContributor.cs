...
namespace Sras.PublicCoreflow.Web.Menus;

public class PublicCoreflowMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public PublicCoreflowMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<PublicCoreflowResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                PublicCoreflowMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
