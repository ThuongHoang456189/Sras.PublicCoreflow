...
{
    public class PaymentRepository : EfCoreRepository<PublicCoreflowDbContext, Payment, Guid>, IPaymentRepository
    {
        private IGuidGenerator _guidGenerator;
        public PaymentRepository(IDbContextProvider<PublicCoreflowDbContext> dbContextProvider, IGuidGenerator guidGenerator) : base(dbContextProvider)
        {
