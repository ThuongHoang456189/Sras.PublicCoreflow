...
namespace Sras.PublicCoreflow.Migrations
{
    ...
    [Migration("20230709140820_Migration40")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.CameraReady", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RootCameraReadyFilePath")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");

                    b.HasKey("Id");

                    b.ToTable("CameraReadies", (string)null);
                });
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.RegistrationPaper", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("MainRegistrationPaperId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("NumberOfExtraPages")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MainRegistrationPaperId");
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.SubmissionAggregationSP", b =>
                {
                    ...
                    b.Property<Guid?>("CameraReadySubId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.SubmissionSummarySPO", b =>
                {
                    b.Property<string>("Abstract")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SelectedSubmissionConflictedIncumbents")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SelectedSubmissionSubjectAreas")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SubmissionQuestionsResponse")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("SubmissionSummarySPOs");
                });
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.WebTemplate", b =>
                {
                    ...
                    b.ToTable("WebTemplates", (string)null);
                });

            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.Website", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.Registration", b =>
                {
                    b.HasOne("Sras.PublicCoreflow.ConferenceManagement.ConferenceAccount", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.RegistrationPaper", b =>
                {
                    b.HasOne("Sras.PublicCoreflow.ConferenceManagement.RegistrationPaper", "MainRegistrationPaper")
                        .WithMany()
                        .HasForeignKey("MainRegistrationPaperId");

                    b.HasOne("Sras.PublicCoreflow.ConferenceManagement.Registration", "Registration")
                        .WithMany("RegistrationPapers")
                    ...
                    b.Navigation("MainRegistrationPaper");
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.Website", b =>
                {
                    ...
                    b.HasOne("Sras.PublicCoreflow.ConferenceManagement.WebTemplate", "WebTemplate")
                        .WithMany("Websites")
            ...
            modelBuilder.Entity("Sras.PublicCoreflow.ConferenceManagement.Registration", b =>
                {
                    b.Navigation("RegistrationPapers");
                });
