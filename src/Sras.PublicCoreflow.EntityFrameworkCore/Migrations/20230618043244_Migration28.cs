    ...
    public partial class Migration28 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NavBar = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    Pages = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Websites_Conferences_Id",
                        column: x => x.Id,
                        principalTable: "Conferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Websites_WebTemplates_WebTemplateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Websites_WebTemplateId",
                table: "Websites",
